...
public class LocationView extends View {
    Label name_app_label = new Label("Dodaj nową lokalizację");
    Label name_label = new Label("Wpisz nazwę lokalizacji:");
    TextField name_location = new TextField();
